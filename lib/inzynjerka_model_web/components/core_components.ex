defmodule InzynjerkaModelWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InzynjerkaModelWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InzynjerkaModelWeb.Gettext, "errors", msg, opts)
    end
  end
